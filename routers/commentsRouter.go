...
func init() {
    ...
    beego.GlobalControllerRouter["system_service/controllers:BranchesController"] = append(beego.GlobalControllerRouter["system_service/controllers:BranchesController"],
    ...
    beego.GlobalControllerRouter["system_service/controllers:UserController"] = append(beego.GlobalControllerRouter["system_service/controllers:UserController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
